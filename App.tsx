...
import { User, Product, Supplier, Page, UserRole } from './types';
import { INITIAL_USERS, INITIAL_PRODUCTS, INITIAL_SUPPLIERS, COMPANY_INFO, INSTALLMENT_RATES, currencyFormatter } from './constants';
...
const DashboardPageContent: React.FC<{user: User; onNavigate: (page: Page) => void}> = ({ user, onNavigate }) => {
    return (
        <div>
